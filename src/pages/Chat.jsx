...
export default function Chat() {
  ...
  const getBotResponse = (userMessage) => {
    ...
    if (lowerMessage.includes('file') || lowerMessage.includes('upload') || lowerMessage.includes('document')) {
    ...
    if (lowerMessage.includes('profile') || lowerMessage.includes('information')) {
        ...
        <div className="flex items-center justify-between">
          ...
          {messages.length > 0 && (
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 text-red-600 hover-red-50 rounded-lg transition"
            >
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          {messages.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Welcome to Healthcare Assistant</h2>
              <p className="text-gray-600 mb-6">
                Start a conversation! Ask me anything about your health, appointments, or medical information.
              </p>
              <div className="grid grid-cols-1 md-cols-2 gap-4 max-w-2xl mx-auto">
                {[
                  ...
                  <button
                    ...
                    className="px-4 py-3 bg-white border border-gray-200 rounded-lg hover-blue-500 hover-blue-50 transition text-left"
                  >
                ...
                >
                  <div
                    className={`p-2 rounded-lg ${
                      msg.sender === 'user' ? 'bg-blue-600' : 'bg-white border border-gray-200'
                    }`}
                  >
                    {msg.sender === 'user' ? (
          ...
          <div className="flex items-end space-x-4">
            <div className="flex-1">
              <textarea
                ...
                rows={1}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus-2 focus-blue-500 focus-transparent resize-none"
              />
            </div>
            <button
              onClick={handleSend}
              disabled={!input.trim() || loading}
              className="px-6 py-3 bg-blue-600 text-white rounded-lg hover-blue-700 transition disabled-50 disabled-not-allowed"
            >
